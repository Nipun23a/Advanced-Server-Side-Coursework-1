...
const startCronJobs = () => {
        ...
        try {
            ...
            if (result) {
                ...
                if (result.notifications) {
                    logger.info(
                        `CRON: Notifications - attempted=${result.notifications.attempted}, ` +
    ...
    logger.info(`CRON: Daily winner selection scheduled at 12:00 AM ${process.env.BID_TIMEZONE || 'Europe/London'}`);
